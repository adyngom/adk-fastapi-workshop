...
For this workshop we will skip those but this ies where you would add your authorized JavaScript origins and redirect URIs.
...
3. You'll see a dialog with two fields:
   - **"The name you want for your key"** ← applyany convention with a descriptive name
...
**continue to project setup document**
